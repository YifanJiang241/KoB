...
export class Snake extends AcGameObjects {
    constructor(info, gamemap){
        ...
        this.status = "idle"; //idle表示静止，move正在移动，die表示失败
    ...
    next_step() {//将蛇的状态变为走下一步
        ...
        // if(!this.gamemap.check_valid(this.next_cell)) {//下一步撞了，蛇死
        //     this.status = "die";
        // }
        //移到后端
    }
    ...
    update_move(){
        ...
        if(distance < this.eps) { //走到目标点了
            ...
            const move_distance = this.speed * this.timedelta / 1000;//每2帧之间走过的距离
